...
def api_create_secret_signing():
    ...
    try:
        ...
        if planned_show_id and opponent_name:
            universe = get_universe()
            roster = []
            if hasattr(universe, "roster") and hasattr(universe.roster, "get_all_wrestlers"):
                roster = universe.roster.get_all_wrestlers()
            elif hasattr(universe, "get_active_wrestlers"):
